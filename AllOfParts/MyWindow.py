...
class MyWindow(FloatLayout):
    def __init__(self, **kwargs):
        ...
        self.start_button = Button(text="Start",size=(self.start_button_x,self.start_button_y//2),size_hint=(None, None), pos=(self.othello_board_x,0))
        ...
        self.image_widget = ImageWidget(widget_size=self.text_widget_size,size=(self.start_button_x,self.start_button_y),size_hint=(None, None),pos=(self.othello_board_x,self.start_button_y))
        self.reset_button = Button(text="Reset",size=(self.start_button_x,self.start_button_y//2),size_hint=(None, None), pos=(self.othello_board_x,self.start_button_y//2))
        ...
        self.reset_button.bind(on_press=self.reset_faze)
